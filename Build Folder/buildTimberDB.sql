...
PRODUCT_SUBCATEGORY VARCHAR2(50),
    CONSTRAINT TIMBER_CATEGORY_PK PRIMARY KEY(CATEGORY#)
);
...
DESCRIPTION_ VARCHAR2(1000) NOT NULL,
PRICE NUMBER(10,2) NOT NULL,
WEIGHT_ NUMBER(5,2) NOT NULL,
TAX_EXEMPTED NUMBER(1) NOT NULL,
    CONSTRAINT PRODUCT_PK PRIMARY KEY(PRODUCT#),
    CONSTRAINT TIMBER_CATEGORY_PRODUCT_FK FOREIGN KEY(CATEGORY#) REFERENCES TIMBER_CATEGORY(CATEGORY#),
